...
OS_CONFIG_BEGIN
  ...
  OS_EVENT_BEGIN
   ...
   OS_EVENT_DEF(EVT_DUMMY_LED        , 0x02)
  OS_EVENT_END

  OS_ALARM_BEGIN
    OS_ALARM_DEF(ALARM_BLINK_LED        ,ALARM_SET_EVENT, EVT_BLINK_LED, T1,   0)
    OS_ALARM_DEF(ALARM_DUMMY_LED        ,ALARM_SET_EVENT, EVT_DUMMY_LED, Idle, 0)
  OS_ALARM_END
